"""
Created on Fri Dec 10   15:31:23 2021

@author: Charlie
"""
#------------------------------------------------------------------------------------------
"""CODE FOR THE DQN AGENT"""  #Understood and adpted from Sentdex
...
class DQNAgent:
    ...
    def best_state(self, states: ValuesView[List[int]]) -> List[int]:
        ...
        if random.random() <= self.epsilon:
            ...
            for state in states:
                ...
                """Finding the best possibel value using the nueral network"""
    ...
    def train(self, batch_size=32, epochs=3):
        ...
        if n >= self.replay_start_size and n >= batch_size:
            ...
            """Improving the performance in this batch by accquiring the next score value"""
            ...
            """Structure to fit the model"""
            for i, (state, _, reward, done) in enumerate(batch):
                if not done:
                    """Partial Q learning formula """
